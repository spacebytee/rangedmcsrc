...
public class MCreatorLMG extends rangedmc.ModElement {

	@GameRegistry.ObjectHolder("rangedmc:lmg")
	public static final Item block = null;
	public static final int ENTITYID = 2;

	public MCreatorLMG(rangedmc instance) {
		super(instance);
		instance.items.add(() -> new RangedItem());
		instance.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("rangedmc", "entitybulletlmg"), ENTITYID).name("entitybulletlmg").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("rangedmc:lmg", "inventory"));
	}
